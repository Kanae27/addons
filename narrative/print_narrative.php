...
<head>
    ...
    <title>Narrative Report - GAD System</title>
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 30px;">
                        <tr>
                            <td style="width: 50%; padding: 10px; border: 1px solid black;">
                                ...
                                <!-- Name stored in name1 field -->
                                <p style="text-align: center; margin-top: 50px; font-weight: bold;">${signatories ? signatories.name7 || '' : ''}</p>
                                <p style="text-align: center; margin-top: 0;">Dean</p>
