...
INSERT INTO `signatories` (`id`, `name1`, `gad_head_secretariat`, `name2`, `vice_chancellor_rde`, `name3`, `chancellor`, `name4`, `asst_director_gad`, `name5`, `head_extension_services`, `name6`, `vice_chancellor_admin_finance`, `campus`, `created_at`, `updated_at`) VALUES
(3, 'Micah Reynolds\n\n', 'GAD Head Secretariat', 'Julian Hayes', 'Vice Chancellor For Research, Development and Extension', 'Aria Sullivan\n\n', 'Chancellor', 'Ezra Mitchell\n\n', 'Assistant Director For GAD Advocacies', 'Lila Gardner\n\n', 'Head of Extension Services', NULL, NULL, 'Malvar', '2025-04-03 08:25:31', '2025-04-07 00:27:02'),
(4, 'Liam Carterseeew', 'GAD Head Secretariat', 'Ava Thompsonhwwwee', 'Vice Chancellor For Research, Development and Extension', 'Noah Reyesew', 'Chancellor', 'Maya Collinsnww', 'Assistant Director For GAD Advocacies', 'Elijah Brooks3wwww', 'Head of Extension Services', NULL, NULL, 'Lipa', '2025-04-03 08:35:45', '2025-04-22 07:10:06'),
(5, 'Sofia Bennett', 'GAD Head Secretariat', 'Caleb Navarro', 'Vice Chancellor For Research, Development and Extension', 'Chloe Ramsey', 'Chancellor', 'Lucas Avery', 'Assistant Director For GAD Advocacies', 'Isla Monroe', 'Head of Extension Services', NULL, NULL, 'Alangilan', '2025-04-07 00:10:02', '2025-04-07 00:10:02'),
(6, 'Elena Harper', 'GAD Head Secretariat', 'Elena Harper', 'Vice Chancellor For Research, Development and Extension', 'Nina Caldwell', 'Chancellor', 'Owen Blake', 'Assistant Director For GAD Advocacies', 'Zoe Chambers', 'Head of Extension Services', NULL, NULL, 'Rosario', '2025-04-07 03:01:41', '2025-04-07 03:01:41');
