                            ...
                            <p style="margin: 0; text-align: center;"><strong>${(() => {
                                ...
                                if (isCentral && window.campusSignatories) {
                                    ...
                                    if (preparedByPosition === "Faculty") {
                                        return window.campusSignatories.name5 || 'Faculty Member';
                                    } else if (preparedByPosition === "Extension Coordinator") {
                                        return window.campusSignatories.name1 || 'Extension Coordinator';
                                    } else if (preparedByPosition === "Director, Extension Services") {
                                        return window.campusSignatories.name2 || 'Director, Extension Services';
                                    } else if (preparedByPosition === "Vice President for RDES" || preparedByPosition === "Vice Chancellor for RDES") {
                                        return window.campusSignatories.name3 || 'Vice President for RDES';
                                    } else if (preparedByPosition === "Vice President for AF" || preparedByPosition === "Vice Chancellor for AF") {
                                        return window.campusSignatories.name4 || 'Vice President for AF';
                                    } else if (preparedByPosition === "GAD Head Secretariat") {
                                        return window.campusSignatories.name6 || 'GAD Head Secretariat';
                                    } else {
                                        // Default fallback
                                    ...
                                    if (preparedByPosition === "Faculty") {
                                        return `<?php echo htmlspecialchars($signatories['name5'] ?? 'Faculty Member'); ?>`;
                                    } else if (preparedByPosition === "Extension Coordinator") {
                                        return `<?php echo htmlspecialchars($signatories['name1'] ?? 'Extension Coordinator'); ?>`;
                                    } else if (preparedByPosition === "GAD Head Secretariat") {
                                        return `<?php echo htmlspecialchars($signatories['name6'] ?? 'GAD Head Secretariat'); ?>`;
                                    } else if (preparedByPosition === "Vice Chancellor for AF") {
                                        return `<?php echo htmlspecialchars($signatories['name4'] ?? 'Vice Chancellor for AF'); ?>`;
                                    } else {
                                        // Default fallback
