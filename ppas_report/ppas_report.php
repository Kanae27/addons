...
<body>
    ...
    <script>
        ...
        function generateReport() {
            ...
            console.log('Generating report for campus:', selectedCampus, 'year:', selectedYear, 'quarter:', selectedQuarter);
        ...
        function displayReport(data, year, quarter, signatories, selectedCampus) {
            ...
            let checkedByPosition = 'Vice Chancellor for Research, Development and Extension Services';
            ...
            if (signatories && signatories.length > 0) {
                ...
                // Find signatories by field names
                signatories.forEach(signatory => {
                    // Map name1 to prepared by
                    if (signatory.name1) {
                        preparedByName = signatory.name1;
                    }
                    
                    // Map name2 to checked by
                    if (signatory.name2) {
                        checkedByName = signatory.name2;
                    }
                    
                    // Map name3 to verified by
                    if (signatory.name3) {
                        verifiedByName = signatory.name3;
                    }
                    
                    // Map name4 to assistant director
                    if (signatory.name4) {
