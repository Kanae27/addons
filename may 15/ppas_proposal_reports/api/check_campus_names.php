...
try {
    ...
    $allSignatories = $conn->query("SELECT id, campus, name1, name2, name3, name4, name5, name6, gad_head_secretariat, vice_chancellor_rde, chancellor, vice_chancellor_admin_finance FROM signatories")->fetchAll(PDO::FETCH_ASSOC);
