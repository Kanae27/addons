            ...
            if (!data || data.length === 0) {
                        ...
                        categoryData.forEach(item => {
                            ...
                            if (activities.length > 0) {
                                ...
                                activities.forEach((act, idx) => {
                                    actualResultsOutput += `   • ${act.activity} (${act.total_male} male, ${act.total_female} female)<br>`;
                                });
                ...
                if (data && data.length > 0) {
                    data.forEach(item => {
                        ...
                        if (item.activities && item.activities.length > 0) {
                            // Calculate each item's total by summing approved budgets and PS attributions
